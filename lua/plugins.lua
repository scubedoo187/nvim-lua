...
return {
	...
	},
	{
		...
		dependencies = { "junegunn/fzf", "tpope/vim-fugitive" },
	},
	...
	{ "mitsuhiko/vim-jinja", ft = { "jinja", "jinja2" } },
	{
		...
		opts = {
			keymaps = {
				toggle = "<C-q>", -- Keybind to toggle Codex window (Disabled by default, watch out for conflicts)
				quit = nil, -- Keybind to close the Codex window (default: Ctrl + q)
